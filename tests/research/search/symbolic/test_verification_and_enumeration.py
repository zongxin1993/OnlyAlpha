...
def test_ordered_enumeration_is_physical_order_invariant_and_prefix_stable() -> None:
    ...
    first = enumerate_symbolic_factor_proposals(
        verify_symbolic_search_space(search_space, generation), proposal_limit=8
    )
    second = enumerate_symbolic_factor_proposals(
        verify_symbolic_search_space(reversed_space, reversed_generation), proposal_limit=8
    )
    prefix = enumerate_symbolic_factor_proposals(
        verify_symbolic_search_space(search_space, generation), proposal_limit=7
    )
...
generation, search_space = space()
result = enumerate_symbolic_factor_proposals(verify_symbolic_search_space(search_space, generation), proposal_limit=10)
