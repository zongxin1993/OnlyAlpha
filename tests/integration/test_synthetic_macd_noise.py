...
def _config(seed: int) -> OnlyRunConfig:
    baseline = OnlyRunConfig.load("examples/backtest_macd/config.yaml")
    ...
    return OnlyRunConfig.from_mapping(payload, source_path="examples/backtest_macd/config.yaml")
