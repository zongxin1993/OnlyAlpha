...
def only_test_execution_fact_draft(
    *,
    ...
    return OnlyCommittedExecutionFactDraft(
        ...
        market_fee_pack_id="TEST_MARKET_FEES",
        market_fee_pack_version="1",
        market_fee_pack_fingerprint="0" * 64,
        broker_fee_contract_id="TEST_BROKER_FEES",
        broker_fee_contract_version="1",
        broker_fee_contract_broker_id="test-broker",
        broker_fee_contract_account_scope="ALL_ACCOUNTS",
        broker_fee_contract_fingerprint="0" * 64,
        fee_binding_fingerprint="0" * 64,
        fee_scope_fingerprint="0" * 64,
        fee_resolution_fingerprint="0" * 64,
        fee_authority="NONE",
        fee_status=OnlyLocalFeeFinality.MODEL_CONFIRMED.value,
        market_fee_schedule_ids=(),
        market_fee_schedule_versions=(),
        market_fee_schedule_fingerprints=(),
        broker_fee_schedule_ids=(),
        broker_fee_schedule_versions=(),
        broker_fee_schedule_fingerprints=(),
