...
from onlyalpha_test_factor_provider.research import OnlyExampleResearchMomentumBackend
from onlyalpha_test_factor_provider.trading import OnlyExampleTradingMomentumBackendFactory
    ...
    return (
        OnlyCalculationBackendRegistration(
            ...
            only_python_implementation_manifest(
                ...
                entrypoint_identity="onlyalpha_test_factor_provider.research:OnlyExampleResearchMomentumBackend",
        ...
        OnlyCalculationBackendRegistration(
            ...
            only_python_implementation_manifest(
                ...
                entrypoint_identity="onlyalpha_test_factor_provider.trading:OnlyExampleTradingMomentumBackendFactory",
                package_root=package_root,
