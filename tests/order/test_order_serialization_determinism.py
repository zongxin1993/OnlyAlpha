...
def _assert_order_determinism(order_request, repetitions: int) -> None:
...
def test_same_inputs_produce_same_ids_snapshots_and_event_order(order_request) -> None:
    _assert_order_determinism(order_request, 3)


@pytest.mark.exhaustive
def test_same_inputs_produce_same_ids_snapshots_and_event_order_for_100_runs(order_request) -> None:
    _assert_order_determinism(order_request, 100)
