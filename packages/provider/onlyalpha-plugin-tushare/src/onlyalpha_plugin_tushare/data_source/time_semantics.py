...
def only_tushare_date_range(time_range: OnlyTimeRange, calendar: OnlyTradingCalendar) -> tuple[str, str]:
...
def only_daily_session(trading_day: OnlyTradingDay, calendar: OnlyTradingCalendar) -> tuple[datetime, datetime]:
