...
environment-injected and redacted; passwords are not printed or passed in PostgreSQL client command arguments. The exact server and
client baseline is governed by ADR 0102 and is identical across production, CI and real-database acceptance.
