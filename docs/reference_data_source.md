...
`CN_A_SHARE_CASH` 不使用上述候选对象或自由 Mapping 作为规则权威。A 股字段由版本化
`OnlyAshareInstrumentReference`、唯一 Registry/Query 和按交易日解析链提供；详见
[CN A-Share Reference Data Authority](reference_data_authority.md) 与 ADR 0029。
