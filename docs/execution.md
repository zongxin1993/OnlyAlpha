...
SIM/Live products remain outside this implemented Backtest scope. SIM 的相同经济 shape 由共享 Trading Kernel 和独立 streaming
product tests 证明；Live 仍是未来目标。See ADR 0053 and ADR 0068.
