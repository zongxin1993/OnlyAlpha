...
_EXPORTS = {
    ...
    "OnlyPrivateStrategyResearchApplicationService": "onlyalpha.application.private_strategy_research",
    "OnlyPrivateStrategyResearchOutcome": "onlyalpha.application.private_strategy_research",
    "OnlyPrivateStrategyResearchRequest": "onlyalpha.application.private_strategy_research",
