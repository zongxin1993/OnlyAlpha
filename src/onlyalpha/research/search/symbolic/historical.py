...
class OnlyVerifiedSymbolicEnumerationResultV1:
    ...
    proposals: tuple[OnlyVerifiedSymbolicProposalV1, ...]
...
def verify_symbolic_enumeration_result(
    ...
    if (
        not isinstance(experiment, OnlySearchExperimentManifestV2)
        or verified_space is None
        or historical_algorithm is None
    ):
    ...
    if result.search_space_fingerprint != verified_space.search_space.search_space_fingerprint:
