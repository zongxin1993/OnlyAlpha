...
def _condition(witness: OnlyNoveltyDecisionWitnessV1) -> OnlyNoveltyPolicyCondition:
...
def only_verify_historical_novelty_decision(
    bundle: OnlyNoveltyDecisionBundleV1,
    policies: OnlyNoveltyPolicyStore,
    ...
    *,
    ...
    try:
        ...
        if negative is not None:
            ...
            selector = _mapping(resolved.get("evaluation_selector"), "evaluation selector")
        ...
        expected = _evaluate(policy, bundle.witness)
