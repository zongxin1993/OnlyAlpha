...
def _verify_groups(statistics_results: tuple[object, ...], rows: tuple[OnlyResearchArtifactStatisticsRow, ...]) -> None:
    from .model import OnlyResearchArtifactStatisticsEntry
