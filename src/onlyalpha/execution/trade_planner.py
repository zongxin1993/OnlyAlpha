...
class OnlyTradeExecutionTransactionPlanner:
    ...
    def _fact(
        ...
        return OnlyCommittedExecutionFactDraft(
            ...
            market_fee_pack_id=context.fee_assessment.binding.market_fee_pack.pack_id,
            market_fee_pack_version=context.fee_assessment.binding.market_fee_pack.pack_version,
            market_fee_pack_fingerprint=context.fee_assessment.binding.market_fee_pack.fingerprint,
            broker_fee_contract_id=context.fee_assessment.binding.broker_fee_contract.contract_id,
            broker_fee_contract_version=context.fee_assessment.binding.broker_fee_contract.contract_version,
            broker_fee_contract_broker_id=context.fee_assessment.binding.broker_fee_contract.broker_id,
            broker_fee_contract_account_scope=context.fee_assessment.binding.broker_fee_contract.account_scope.to_json(),
            broker_fee_contract_fingerprint=context.fee_assessment.binding.broker_fee_contract.fingerprint,
            fee_binding_fingerprint=fee.binding_fingerprint,
            fee_scope_fingerprint=context.fee_assessment.binding.applicability_scope.fingerprint,
            fee_resolution_fingerprint=fee.resolution_fingerprint,
            ...
            market_fee_schedule_fingerprints=_schedule_values(market_components, "schedule_fingerprint"),
