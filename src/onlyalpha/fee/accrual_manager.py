...
from .accrual import OnlyOrderFeeAccrualExecutionState


class OnlyOrderFeeAccrualManager:
    def __init__(self) -> None:
        self._states: dict[OnlyOrderId, OnlyOrderFeeAccrualExecutionState] = {}

    def get(self, order_id: OnlyOrderId) -> OnlyOrderFeeAccrualExecutionState | None:
        return self._states.get(order_id)

    def restore(self, state: OnlyOrderFeeAccrualExecutionState) -> None:
    ...
    def restore_checkpoint(self, payload: object) -> None:
        ...
        states = tuple(OnlyOrderFeeAccrualExecutionState.from_json(str(item)) for item in payload)
